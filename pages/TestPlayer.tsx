                   ...
                   <div className="glass-card p-6 md:p-10 rounded-2xl border border-white/10">
                       ...
                       <div className="space-y-3">
                           {currentQuestion.options.map((option, idx) => (
                               ...
                               >
                                   <div className={`w-6 h-6 rounded-full border mr-4 flex items-center justify-center text-xs font-bold ${
                                       answers[currentQIndex] === idx ? 'bg-teal-500 border-teal-500 text-white' : 'border-slate-600 text-slate-500'
                                   }`}>
                           ...
                           {test.questions.map((_, idx) => (
                               <button
                                   ...
                                   className={`w-8 h-8 rounded-lg text-xs font-bold flex items-center justify-center transition-all ${
                                       currentQIndex === idx ? 'ring-2 ring-white bg-teal-500 text-white' :
