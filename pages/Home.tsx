          ...
          <div className="flex flex-col items-center text-center">
             <Reveal delay={0} width="fit-content">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 hover:bg-white/10 transition-colors cursor-default">
                    ...
                    <span className="text-sm font-medium text-teal-100">Admissions Open for GPAT 2026</span>
                </div>
             </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={idx} delay={idx * 100}>
                <div 
                    className="glass-card rounded-3xl p-8 hover:bg-slate-800/80 transition-all duration-500 group cursor-pointer hover:-translate-y-2 h-full border border-white/5 hover:border-teal-500/30 relative overflow-hidden"
                >
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${cat.color} blur-[60px] rounded-full pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
                    
                    <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 border border-white/10 shadow-lg relative z-10">
                        <div className="text-teal-400 group-hover:text-white transition-colors duration-500">
                            {cat.icon}
                        </div>
                    </div>
                    <div className="relative z-10">
                        <h3 className="text-xl font-bold text-white mb-2">{cat.title}</h3>
                        <p className="text-xs font-bold text-teal-400 mb-4 uppercase tracking-wide bg-teal-950/30 px-2 py-1 rounded w-fit">{cat.exams}</p>
