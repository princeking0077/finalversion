...
export const CourseDetail = () => {
  ...
  const handleEnroll = () => {
    // Open the external Google Form for enrollment
    window.open('https://forms.gle/BgrejR14F9jmB4FJ7', '_blank');
  };
            ...
            <Reveal delay={400}>
                ...
                <div className="flex border-b border-white/5 bg-slate-900/50">
                    ...
                    <button
                        ...
                        className={`flex-1 py-4 text-center font-medium text-sm capitalize transition-all relative ${
                        activeTab === tab ? 'text-teal-400' : 'text-slate-400 hover:text-white'
                        }`}
                    >
                        {tab}
